      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto">
          ...
          {/* <select
            defaultValue="all"
            className="h-10 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-600 
            outline-none transition focus:border-[#0B1F3A] focus:ring-2 focus:ring-[#0B1F3A]/10 sm:w-36"
          >
          ...
          <button
            type="button"
            onClick={onReset}
            className="inline-flex h-10 items-center justify-center gap-2 rounded-lg px-3 text-sm 
            font-medium text-gray-500 transition hover:bg-gray-100 hover:text-[#0B1F3A]"
          >
            <RotateCcw size={16} />
            Reset
          </button>
