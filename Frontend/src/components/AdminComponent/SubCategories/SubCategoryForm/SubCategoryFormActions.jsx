...
function SubCategoryFormActions({ isSubmitting, mode }) {
    ...
    <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
      ...
      <button
        ...
        className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg border 
              ...
              hover:border-gray-300 hover:bg-gray-50 hover:text-[#0B1F3A] focus:outline-none focus:ring-2 
              focus:ring-[#0B1F3A]/10 sm:w-auto"
      >
        <X size={17} />
        Cancel
      </button>
      ...
      >
        <Check size={17} strokeWidth={2.5} />
        {
          isSubmitting 
            ...
            : `${mode === "edit" ? "Update Sub-category" : "Add Sub-category"}`
        }
      </button>
    </div>
  );
